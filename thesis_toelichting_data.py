# -*- coding: utf-8 -*-
"""Thesis_toelichting_data

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qlnN-LrgPhIyS_ITRL6DJNFxNFG2sSow
"""
...
all_sentences = ex_data['exp_allsentences']
category = ex_data['exp_categorie']
...
print("Categories:", ex_data.columns.tolist())

#Some example sentences:
print("\nSome examples sentences:")
print(ex_data['exp_goodadvice'][:5])
...
#Data cleaning and preprocessing: make sure all text is str, make lower case and delete irrelevant punctuation and stopwords without stopword removal
data['Zou u uw antwoord kunnen toelichten?'] = data['Zou u uw antwoord kunnen toelichten?'].astype(str)
explanations = np.asarray(data["Zou u uw antwoord kunnen toelichten?"])

for nr in range(len(explanations)):
  explanations[nr] = alpha(explanations[nr]).lower()

for nr in range(len(all_sentences)):
  all_sentences[nr] = alpha(all_sentences[nr]).lower()

for nr in range(len(test_set)):
  test_set['sentence'][nr] = alpha(test_set['sentence'][nr]).lower()
