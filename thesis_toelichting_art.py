# -*- coding: utf-8 -*-
"""Thesis_toelichting_art

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dTb-BX8ogfTNU_-A2Hn7ycUSUs021mh3
"""
...
sentence = "Deze zin moet ^ gefilterd 5 worden van stopwoorden ! 78 cijfers en en punctuatie % 63"
print(filter_stopwords(sentence, stopwords))
print(alpha(sentence))
print(alpha(filter_stopwords(sentence, stopwords)).lower())

#Import all data
data = pd.read_excel(r"/content/drive/My Drive/Files/NPS_toelichting.xlsx")
#good = pd.read_excel(r"/content/drive/My Drive/Files/NPS_goede_punten.xlsx")
#suggest = pd.read_excel(r"/content/drive/My Drive/Files/NPS_verbeterpunten.xlsx")
...
test_set = pd.read_excel(r"/content/drive/My Drive/Files/test_set_final.xlsx", sheet_name = 'explain')[['sentence', 'final']]
#test_set_good = pd.read_excel(r"/content/drive/My Drive/Files/test_set_final.xlsx", sheet_name = 'good')[['sentence', 'final']]
#test_set_suggest = pd.read_excel(r"/content/drive/My Drive/Files/test_set_final.xlsx", sheet_name = 'suggest')[['sentence', 'final']]
...
#Exploring raw data
print("explanations: ", len(data), " responses")
#print("good points: ", len(good), "responses")
#print("suggestions: ", len(suggest), "responses")
print("")
...
#print(suggest.columns.tolist())

#Exploring example sentences
print("Number of categories for explanation question:", len(ex_data.columns.tolist()))
...
#print()
#print("Number of categories for good points question:", len(good_ex_data.columns.tolist()))
#print("Total number of example sentences:", good_ex_data.size) #check that this is number of categories * 10
#print("Categories:", good_ex_data.columns.tolist())
#print()
#print("Number of categories for suggestions question:", len(suggest_ex_data.columns.tolist()))
#print("Total number of example sentences:", suggest_ex_data.size) #check that this is number of categories * 10
#print("Categories:", suggest_ex_data.columns.tolist())
print()


#Some example sentences:
print("Some examples sentences:")
print(ex_art['exp_goodadvice'][:5])
...
y_pred = predictions
labels = ['app werkt goed', 'geen fijn gesprek', 'geen goed concept',
       'goed concept', 'app werkt slecht', 'snelle reactie',
       'goed advies', 'fijn gesprek', 'slecht advies', 'langzame reactie', 'anders']
...
data = [
    go.Scatter(
        ...
        y=[i[1] for i in y],
        mode='markers',
        text=[i for i in all_sentences], #set text equal to either sentence or category
    marker=dict(
        size=16,
        color = [i for i in category_num], #set color equal to category
        opacity= 0.8,
        colorscale='Rainbow',
        showscale=False
    )
