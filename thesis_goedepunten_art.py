# -*- coding: utf-8 -*-
"""Thesis_goedepunten_art

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1EkcNKX1RYQhoJLBoc1GB74nJoWzVSHlE
"""
...
test_set = pd.read_excel(r"/content/drive/My Drive/Files/test_set_final.xlsx", sheet_name = 'good')[['sentence', 'final']]
...
print("Total number of example sentences:", ex_data.size) #check that this is number of categories * 10
...
for similarity in similarities[0:3]:
  neighbors = np.argsort(np.reshape(similarity, 90))[-5:][::-1]
  ...
  k = 1
  for j in neighbors:
    if category[j] == 'arts' or category[j] == 'negatief' or category[j] == 'expertise' or category[j] == 'advies':
...
y_pred = predictions
labels = ['advies', 'openingstijden', 'negatief', 'reactietijd', 'app werkt goed', 'gesprek', 'goed concept', 'expertise', 'arts']
